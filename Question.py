...
def get_keyboard_distance(char1, char2):
    """Return the distance between two characters using the keyboard distance matrix."""
    char1 = char1.lower()
...
class Question:
    ...
    def __str__(self):
        return f"Question(Word: '{self.word.word}', Try: '{self.try_answer}', Levenshtein distance: {self.levenshtein_distance}, Neighbor distance: {self.neighbors_distance})"
